...
export const metadata: Metadata = {
  title: 'ヒビノクラシについて',
  description: '保育士が営む、気仙沼市の古民家宿泊施設「ヒビノクラシ」について。1日1組限定・保育士常駐・築100年の古民家。想いと、スタッフと、この場所のことを。',
  alternates: { canonical: 'https://hibinokurashi.jp/about/' },
  openGraph: { url: 'https://hibinokurashi.jp/about/' },
}
...
const features = [
  ...
  },
  {
    n: '03',
    title: '地域と、つながる体験。',
    body: '気仙沼の海・山・里——地元の自然や生産者さんと触れ合うことができます。ただ泊まるだけでなく、その土地の暮らしを体験することで、家族の記憶に残る旅になります。',
  },
  {
    n: '04',
          ...
          <FadeUp delay={80}>
            <div className="about-story">
              ...
              <div className="about-story-text">
                ...
                <p>
                  気づいたのは——幸せは特別な出来事よりも、日々の暮らしの中にある、ということ。おいしいごはん、縁側での昼寝、地元の食材で一緒に食べること。土を触ること、虫を捕まえること。そんな小さな積み重ねが、家族の記憶をつくっていく。
                </p>
                <p>
                  築100年の古民家を拠点に、気仙沼の海・山・里の暮らしを体験してほしい。そんな想いから、ヒビノクラシは生まれました。
                </p>
              </div>
            </div>
          </FadeUp>
